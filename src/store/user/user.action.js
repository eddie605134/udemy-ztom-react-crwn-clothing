...
export const signInFailure = (error) => createAction(USER_ACTION_TYPE.SIGN_IN_FAILURE, error)
...
export const signUpFailure = (error) => createAction(USER_ACTION_TYPE.SIGN_UP_FAILURE, error)
...
export const signOutFailure = (error) => createAction(USER_ACTION_TYPE.SIGN_OUT_FAILURE, error)
